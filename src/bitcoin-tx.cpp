...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s noodlyappendagecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  noodlyappendagecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded noodlyappendagecoin transaction") + "\n" +
              "  noodlyappendagecoin-tx [options] -create [commands]   " + _("Create hex-encoded noodlyappendagecoin transaction") + "\n" +
              "\n";
